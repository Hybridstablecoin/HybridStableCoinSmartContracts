...
/**
 * EURH Token Smart Contract: EIP-20 compatible token smart contract that
 * manages EURS tokens.
 */
contract EURHToken is AbstractToken {
  /**
  ...
  /**
   * Create EURH Token smart contract with message sender as an owner.
   *
   * @param _feeCollector address fees are sent to
   */
  function EURHToken (address _feeCollector) public {
